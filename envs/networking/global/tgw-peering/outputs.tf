...
output "peering_euw2_usw1" {
  description = "TGW peering attachment euw2 <-> usw1"
  value = {
    requester = aws_ec2_transit_gateway_peering_attachment.euw2_usw1
    accepter  = aws_ec2_transit_gateway_peering_attachment_accepter.euw2_usw1
  }
}
...
output "peering_euw1_usw1" {
  description = "TGW peering attachment euw1 <-> usw1"
  value = {
    requester = aws_ec2_transit_gateway_peering_attachment.euw1_usw1
    accepter  = aws_ec2_transit_gateway_peering_attachment_accepter.euw1_usw1
  }
}

output "peering_usw2_usw1" {
  description = "TGW peering attachment usw2 <-> usw1"
  value = {
    requester = aws_ec2_transit_gateway_peering_attachment.usw2_usw1
    accepter  = aws_ec2_transit_gateway_peering_attachment_accepter.usw2_usw1
  }
}
